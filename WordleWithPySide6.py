...
from PySide6.QtWidgets import QApplication, QWidget, QPushButton, QLineEdit, QVBoxLayout, QHBoxLayout, QMessageBox
...
class GuessingGame(QWidget):
	...
	def check_guess(self): #verifica se a palavra ta certa
		...
		for self.line_edit in self.letters_boxes: #limpa as letras e coloca o cursor no inicio
